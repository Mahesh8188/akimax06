...
OWNER_ID = environ.get("OWNER_ID", "6859451629")   # yaha apna Telegram ID daalna
# Owners
ADMINS = [
    int(admin) if id_pattern.search(admin) else admin
    for admin in environ.get("ADMINS", "6859451629 7386197638").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "Mahesh8182"
)  # without @ or https://t.me/
USERNAME = environ.get("USERNAME", "Mahesh8182")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1002372764752").split()
]
...
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "-1002084819782"))
request_channel = environ.get("REQUEST_CHANNEL", "-1002084819782")
REQUEST_CHANNEL = (
    int(request_channel)
...
SHORTENER_API2 = environ.get(
    "SHORTENER_API2", "1492d7161b70dea738aa23dcb3163be93b624a6d"
)
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "aklinkpays.in")
SHORTENER_API3 = environ.get(
    "SHORTENER_API3", "1492d7161b70dea738aa23dcb3163be93b624a6d"
)
...
TMDB_API_KEY = environ.get("TMDB_API_KEY", "cbea51d46583c6e441be0e8df232cf07")
